...
void main() {
  ...
  test('creates a reservation from the selected combination after permission check', () async {
  ...
  test('does not call the reservation API when required permission is missing', () async {
    final apiClient = _FakeReservationClient();
    final service = ReservationService(
      apiClient,
  ...
  test('updates a reservation with the selected combination and current input', () async {
    final apiClient = _FakeReservationClient();
    final service = ReservationService(
      apiClient,
      _FakeCallPermissionService(CallPermissionStatus.ready),
